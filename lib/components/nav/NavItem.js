...
var NavItem = function (_React$Component) {
  ...
  _createClass(NavItem, [{
    ...
    value: function toCommandBarItem(el, inheritedProps, navigator) {
      var _el$props = el.props,
          label = _el$props.label,
          icon = _el$props.icon,
          style = _el$props.style,
          iconStyle = _el$props.iconStyle,
          overflow = _el$props.overflow,
          far = _el$props.far;

      var theme = inheritedProps.theme || el.props.theme || {};
      var navigatorTheme = theme.Navigator || {};
      var rootStyle = Object.assign({}, navigatorTheme.item, style);
      var iconStyl = Object.assign({}, navigatorTheme.icon, iconStyle);
      ...
      return Object.assign({
        ...
        onClick: function onClick() {
          return navigator && navigator.navigateHandler(el.key);
        }
