...
var Navigator = function (_React$Component) {
  ...
  _createClass(Navigator, [{
    ...
    value: function render() {
      ...
      var rootStyle = Object.assign({}, _fsts.JS.lessProps(theme.Navigator, ['item', 'icon']), style);
      ...
      var all_items = _react2.default.Children.map(this.props.children, function (child, index) {
        ...
        return _NavItem2.default.toCommandBarItem(child, inheritedProps, navigator);
      });
